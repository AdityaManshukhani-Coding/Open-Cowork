...
#ifndef OPENCOWORK_SWIFT_H
#define OPENCOWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenCowork",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC10OpenCowork11AppDelegate")
...
@class NSBundle;
SWIFT_CLASS("_TtC10OpenCowork19OpenCoworkResources")
@interface OpenCoworkResources : NSObject
...
@class NSWindow;
SWIFT_CLASS("_TtC10OpenCowork20StatusItemController")
@interface StatusItemController : NSObject <NSWindowDelegate>
...
@class NSCoder;
SWIFT_CLASS("_TtC10OpenCowork17TextContainerView")
@interface TextContainerView : NSView
